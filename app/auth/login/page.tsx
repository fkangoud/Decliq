...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Forcer le rechargement complet pour que les cookies soient bien écrits
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="font-semibold text-slate-900 text-lg">Décliq</span>
        </div>

        <div className="bg-white rounded-2xl border border-slate-200 p-8">
          <h1 className="text-xl font-semibold text-slate-900 mb-1">Connexion</h1>
          <p className="text-sm text-slate-500 mb-6">Content de vous revoir !</p>

          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 border border-slate-200 rounded-xl py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors mb-6"
          >
